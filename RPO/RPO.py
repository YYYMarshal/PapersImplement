...
class Agent(nn.Module):
    ...
    def get_action_and_value(self, device, x, action=None):
...
def main():
    ...
    for update in range(1, num_updates + 1):
        ...
        for step in range(0, args.num_steps):
            ...
            with torch.no_grad():
                action, logprob, _, value = agent.get_action_and_value(device, next_obs)
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                _, newlogprob, entropy, newvalue = agent.get_action_and_value(device, b_obs[mb_inds],
                                                                              b_actions[mb_inds])
